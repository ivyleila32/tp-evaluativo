/*A partir del ejemplo con uso de menúes múltiples, separar en todos los archivos .hpp y .cpp 
necesarios; de modo tal que en el archivo main.cpp solo quede:
...
Además construir el script (.bat o .sh) para compilar todo el proyecto.
 La tarea deberán entregarla en un repositorio de GitHub.
  Osea solo me tienen que entregar un enlace a su repositorio.*/
